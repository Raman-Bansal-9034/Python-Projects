...
tim.speed("fastest")
tim.penup()  # To hide the line that are drawn when the turtle create the dots or move from one position to another.
tim.hideturtle()  # To hide our turtle so that it doesn't appear when we are drawing dots.
tim.setheading(220)
tim.forward(300)
tim.setheading(0)
number_of_dots = 100
